...
)
{
    ...
    header << "\n";
    header << "#include \"lax/token.h\"\n";
    header << "#include \"lax/object.h\"\n";
    header << "#include \"lax/source.h\"\n";
    header << "\n\n";
    header << "namespace lax\n";
    header << "{\n";
    header << "\n\n";
...
main(int argc, char** argv)
{
    ...
    write_code(source, header,  "lax_expression.h");
